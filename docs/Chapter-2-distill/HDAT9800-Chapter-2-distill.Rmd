...
- `dplyr` and related packages (`tidyr`, `purrr`) worth learning
  - we'll cover `tidyr` and `purrr` briefly in a later intercative session 
...
- artists and designers tend to be good at preparing beuatiful or pleasing visualsiations, but care less about the accuracy of what they are presenting
- three parts:
...
- good and bad examples, using the same data
  ...
  - **wrong** - a chart with objective, mathematical errors, undisputably incorrect
...
- aethetics describe every aspect of a particular graphical element
...
# Setting up you own blog site

- create a repository (repo) for the blog under your personal GitHub account
  - can be a public or private repository
    - private can be made public later, not v-v
- set up a new RStudio project and clone that repo to your computer
...
- further customisation of your blog site
...
- change Pages directory to branch main, docs/ directory
