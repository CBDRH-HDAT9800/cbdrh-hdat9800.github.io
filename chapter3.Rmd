...
The slide deck in HTML (web) format for the session can be accessed <a class='fa fa-file-powerpoint' href='Chapter-3-ggplot2/HDAT9800-Chapter-3-ggplot2.html' target='_blank'> here</a> (a PDF version will be provided later)).
