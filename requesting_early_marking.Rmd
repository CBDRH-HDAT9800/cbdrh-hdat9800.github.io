...
For the Term 2 2022 running of teh HDAT9800 course, we are offering early marking of core assignments (those for Chapters 1 to 7). This enables students to work at their own pace through the core curriculum material and the corresponding assessments, potentially leaving more time to work on the two additional assessments, the group assessment and otherwise engage with the additional material offered in each Chapter.

If you have complete a chapter assessment and submitted a final version of your solution to git, and pushed that to your assessment repo on GitHub (the repo that was automatically created for you when you clicked on the assignment link), then yo can request early marking (before the assessment due date) by carrying out the following steps:
...
4. This will open a new issue form. Fill it out as shown below in the red highlit ovals, with "Ready for marking" as the issue title, and `@timchuches @OSotade` as the boddy of the issue (that will make it show up in the course instructors open issues lists, see below). When you have filled those in, click the **Submit new issues** button as highlighted below.
