...
This course was originally developed in 2018 by Dr James Farrow and Dr Tim Churches. It was presented by James in 2018 and 2019, and co-presented by James and Tim in entirely online form in 2020, and by Tim and Andy Blance in 2021. Although the core material for the course remains substantially unchanged, a great deal of additional material was added in 2021, and for 2022 some further topics will be covered.
...
tutorials <- c(
"2-4:30pm (F2F) & 5:30-8pm (online), Thur 2 Jun",
"2-4:30pm (F2F) & 5:30-8pm (online), Thur 9 Jun",
"2-4:30pm (F2F) & 5:30-8pm (online), Thur 16 Jun",
"2-4:30pm (F2F) & 5:30-8pm (online), Thur 23 Jun",
"2-4:30pm (F2F) & 5:30-8pm (online), Thur 30 Jun",
"Study period T2, no tutorial",
"2-4:30pm (F2F) & 5:30-8pm (online), Thur 14 Jul",
"2-4:30pm (F2F) & 5:30-8pm (online), Thur 21 Jul",
"2-4:30pm (F2F) & 5:30-8pm (online), Thur 28 Jul",
"2-4:30pm (F2F) & 5:30-8pm (online), Thur 4 Aug"
)
...
kbl(df, 
    escape = FALSE,
    align = c('l', 'l', 'l', 'l', 'c', 'c', 'l', 'c', 'c'),
    col.names = c("Week", "Week starting", "Core topic(s)", "learnr tutorial link", "Additional topic(s)", 'Tutorial', 'Chapter web page', "Tutorial recordings")
    ) %>% 
...
Online, hosted versions of the learnr tutorials for this course can be accessed through the links in the Course Schedule table above, but it is better to use a local copy that you can work on in the RStudio environment without the need for internet access. 

Once installed, the tutorials can be accessed via the **Tutorial** tab in the upper righthand pane of the RStudio application.
...
Instructions for installing the R tutorials package for Chapter 2 to 9 of the HDAT9800 course will appear here in the near future.
...
## Additional curriculum assessments
