...
kbl(df, 
    escape = FALSE,
    align = c('l', 'l', 'l', 'l', 'c', 'c', 'l', 'c'),
    col.names = c("Week", "Week starting", "Core topic(s)", "Additional topic(s)", 'Online Tutorial', 'Face-to-Face Tutorial',  'Chapter web page', "Tutorial recordings")
    ) %>% 
