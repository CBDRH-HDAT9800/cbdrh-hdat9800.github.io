...
For Term 2 2022, the course is provided in both blended (hybrid) and online formats. Each Chapter, which corresponds to a week in the ten week course, comprises pre-recorded lectures, interactive tutorials which student work through themselves, and a weekly interactive tutorial session. These tutorial sessions are provided in both online and face-to-face form (on the UNSW Kensington campus).
...
learnrLinks <- c(
  ...
  rep("<a class='fa fa-clock' href='https://media.giphy.com/media/XIqCQx02E1U9W/giphy.gif' target='_blank'></a>", 6)
)
