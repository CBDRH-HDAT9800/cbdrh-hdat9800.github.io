...
![](images/wallpaperflare-cropped.jpeg)
...
kbl(df, 
    escape = FALSE,
    align = c('l', 'l', 'l', 'c', 'l', 'c'),
    col.names = c("Week", "Week starting", "Topic", 'learnr tutorial', 'Online tutorial', 'Tutorial slides')
    ) %>% 
...
df <- data.frame(
  ...
  link <- c(
    "<a class='fa fa-github' href='https://www.youtube.com/watch?v=dQw4w9WgXcQ' target='_blank'></a>",
    "<a class='fa fa-github' href='https://www.youtube.com/watch?v=dQw4w9WgXcQ' target='_blank'></a>",
    "<a class='fa fa-github' href='https://www.youtube.com/watch?v=dQw4w9WgXcQ' target='_blank'></a>",
    "<a class='fa fa-github' href='https://www.youtube.com/watch?v=dQw4w9WgXcQ' target='_blank'></a>"
  )
