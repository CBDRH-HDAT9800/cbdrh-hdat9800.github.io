...
The slide deck in HTML (web) format for the session can be accessed <a class='fa fa-file-powerpoint' href='Chapter-4-ggplot2/HDAT9800-Chapter-4-ggplot2.html' target='_blank'> here</a> (a PDF version will be added here).

The slide deck for Dr Georgie Kennedy's talk on data viz in python will be posted here shortly.
