...
embed_url("https://youtu.be/NZZnwKvb3BM")
```
...
A slide deck for the session will be provided here just before the nline session.
...
**Be sure that you can successfully knit the `Rmd` (R markdown) document that you will be working on in thos assessment, before you commit and push your final version. The instructors will be marking your `Rmd` file by re-rendering it (re-knitting it).**
